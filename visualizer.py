...
# Build sorted list of all signals with trade outcomes for buys
_all_signals = []
...
if not _all_signals:
    ...
    # Zoomed chart: ±30 trading days around the signal
    _WIN    = 30
